...
public class Program extends Application implements EventHandler<Event> {
    ...
    public void start(Stage stage) {
        ...
        Label thread_label1 = new Label("1-st thread priority: ");
        ...
        thread_box1.getChildren().addAll(thread_label1, thread1_value_label, thread1_up, thread1_down);
        thread_box1.setAlignment(Pos.TOP_CENTER);
        thread_box1.setSpacing(10);

        Label thread_label2 = new Label("2-nd thread priority: ");
        ...
        thread_box2.getChildren().addAll(thread_label2, thread2_value_label, thread2_up, thread2_down);
        ...
        center_pane.getChildren().addAll(button_box, thread_box1, thread_box2);
        ...
        DisableButton();
        Scene scene = new Scene(main_pane, 400, 170);
